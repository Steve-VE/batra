...
<div class="container">
    <form action="#" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="six columns" id="cologneG" >
                <div class="row">
                ...
                <div class="row">
                    <div class="twelve columns"><!-- dénomination -->
                        <div class="row">
                ...
                <div class="row">
                    <div class="twelve columns"><!-- liste ingrédient -->
                        <div class="row">
                            <div class="six columns">
                ...
                <div class="row">
                    <div class="twelve columns"><!-- alégéne -->
                    <b>liste des allergènes</b>
                    <br>
                        <ul>
                            <?php foreach($allergens_list as $allergen){?>
                                <li class="row">
                                            <label class="six columns" for="allergen_<?= $allergen;?>"><?= ucfirst($allergen);?> :</label>
                                        
                                            <select class="six columns" name="allergen_<?= $allergen;?>" id="">
            ...
            <div class="six columns" id="cologneD" >
                <div class="row">
                    <div class="twelve columns"><!--photo du produit-->
